...
newTab("secretAnimation.js", "js");
tb("secretAnimation");
ge.t.data[0]= "Thank you so much for your continued support, dear patrons!";
ge.t.carets[0].x = ge.t.data[0].length;
}

secretAnimationSpeed = 2.05;
resetSecretAnimation = function() {
    fullArr = [];
    nextArr = [];
